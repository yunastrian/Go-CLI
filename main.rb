...
#Prepare file for save history data
...
if parameter.length == 0
    #Program executed with no parameter
    map = Array.new(20) {Array.new(20, 0)}
	
    #Generate driver position
    5.times do
        loop do 
            x = Random.rand(20)
            y = Random.rand(20)
    ...
    #Program executed with 3 parameters
    ...
    #Program executed with input file 
